...
<style>
    ...
    /* Improved Grooming Services Styles */
    .services-section { margin-top: 20px; }
    .services-grid { display: grid; grid-template-columns: 1fr; gap: 15px; margin-top: 15px; }
    .service-card { 
    ...
    @media (min-width: 768px) {
        ...
        .services-grid { grid-template-columns: repeat(auto-fill, minmax(320px, 1fr)); gap: 25px; margin-top: 20px; }
        .service-card { 
            border-radius: 12px; 
            padding: 25px; 
        }
...
<div class="content-section">
    ...
    <!-- Grooming Services Section (Only for grooming type shelters) -->
    @if($shelter->type === 'grooming' && $shelter->groomingServices->count() > 0)
    <div class="details-card services-section">
        <div class="card-header">
            <h3 class="section-title"><i class="fas fa-cut"></i> Pet Grooming Services</h3>
        </div>
        
        <div class="services-grid">
            @foreach($shelter->groomingServices as $service)
                    ...
                    <div class="service-meta">
                        @if($service->duration)
                            <div class="service-duration">
                                <i class="fas fa-clock service-icon"></i> {{ $service->duration }} minutes
                            </div>
                        @endif
