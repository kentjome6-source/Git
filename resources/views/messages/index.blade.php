...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateNavigationUnreadCount() {
        ...
        .then(data => {
            const navBadge = document.querySelector('#messages-nav-badge');
            if (navBadge) {
    ...
    function subscribeToChannels() {
        ...
        if (selectedUserId && typeof window.subscribeChatChannel === 'function') {
            try {
                ...
                const minUserId = Math.min(currentUserId, selectedUserId);
                const maxUserId = Math.max(currentUserId, selectedUserId);
                chatChannel = window.subscribeChatChannel(minUserId, maxUserId);
                if (chatChannel) {
