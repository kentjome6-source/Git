...
@section('title', 'List Pet for Adoption - Vet')
        ...
        <div class="col-8">
            <div class="card shadow">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('vet.adoptions.management.store') }}" method="POST" enctype="multipart/form-data" aria-labelledby="form-heading">
                        @csrf
                        ...
                        <div class="d-flex justify-content-between flex-wrap gap-2 adoption-form-buttons">
                            <a href="{{ route('vet.adoptions.management.index') }}" class="btn btn-secondary cancel-btn" role="button" aria-label="Cancel and return to adoptions">
                                Cancel
                            </a>
