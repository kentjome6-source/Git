            ...
            <div class="col-lg-8">
                <div class="form-card">
                    ...
                    <div class="form-header">
                        <h1 class="form-title">List Pet for Adoption</h1>
                        <p class="form-subtitle">Fill out the information below to list your pet for adoption</p>
                    </div>

                    <form action="{{ route('adoptions.store') }}" method="POST" enctype="multipart/form-data" id="createAdoptionForm">
                        @csrf
                        ...
                        <div class="form-section">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('health_status') is-invalid @enderror" 
                                          ...
                                          placeholder="Describe the pet's current health condition...">{{ old('health_status') }}</textarea>
                                @error('health_status')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('vaccination_records') is-invalid @enderror" 
                                          ...
                                          placeholder="List any vaccinations and dates...">{{ old('vaccination_records') }}</textarea>
                        ...
                        <div class="form-section">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('description') is-invalid @enderror" 
                                          ...
                                          placeholder="Tell potential adopters about this pet's personality, habits, and special needs...">{{ old('description') }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
