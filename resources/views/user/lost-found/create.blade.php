...
@section('content')
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Using the correct coordinates from the seeder data: approximately [8.507, 125.977]
            const map = L.map('map').setView([8.507, 125.977], 15);
